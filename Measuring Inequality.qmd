...
*Level of consumption per capita per each household.*
...
```
#### Plotting adjusted distribution 
After correcting for outliers and transforming the dependent variable through a logaritmic specification
...
#### Compute the budget shares of food and non-food consumption for the representative households in each region.
...
#### (b) Poverty threshold  set to two dollars a day, or 474 franc CFA in 1987.

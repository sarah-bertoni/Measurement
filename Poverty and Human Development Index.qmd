...
**Compute the equivalized** **household size and the household's adult-equivalent income.**
...
**Estimation of the median adult-equivalent income as accurately as you can, using all the available information in the data. Then calculate, for each country, the poverty threshold according to the EU definition.**
...
**Percentage of households who are poor, and the percentage of individuals who are poor according to this definition, using weights.**
...
### 2.1 Old vs. new definition of the HDI index
...
[**Example of Ireland and Luxembourg:**]
...
** Increasing LE in bottom and top GNI countries:**
...
** Perform the same comparison using the new version of the HDI index**
